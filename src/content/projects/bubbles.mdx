...
import MobileNote from '../../components/MobileNote.astro';
import bubblesGlsl from '../../shaders/bubbles.glsl?raw';

<ShaderPreview code={bubblesGlsl} />
<MobileNote message="This shader is GPU-intensive. On mobile, you may see lower framerates or visual artifacts - for the best experience, view on desktop." />
